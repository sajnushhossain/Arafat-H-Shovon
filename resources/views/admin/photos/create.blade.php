...
@section('title', 'Upload Photo for ' . $gallery->title)

@section('content')
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-semibold mb-6">Upload Photo for "{{ $gallery->title }}"</h1>
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form action="{{ route('admin.galleries.photos.store', $gallery->slug) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-4">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('admin.galleries.photos.index', $gallery->slug) }}" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">
                        Cancel
                    </a>
                </div>
            </form>
